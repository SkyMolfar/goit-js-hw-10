...
parcelHelpers.export(exports, "searchCountries", ()=>searchCountries);
// fetchCountries.js
...
const fetchCountries = (name)=>{
    ...
    return (0, _axiosDefault.default).get(`https://restcountries.com/v2/name/${name}`, {
        ...
        if (error.response && error.response.status === 404) throw new Error("Country not found");
        else {
...
const searchCountries = (0, _lodashDebounceDefault.default)((searchValue, callback)=>{
    const sanitizedValue = searchValue.trim();
    if (sanitizedValue === "") {
        callback([]);
        return;
    }
    fetchCountries(sanitizedValue).then((data)=>{
...
},{"axios":"jo6P5","lodash.debounce":"3JP5n","notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
